 ...
 */
package com.amazonaws.mws.merchantfulfillment.mock;


import com.amazonaws.mws.merchantfulfillment.MWSMerchantFulfillmentService;
...
public class MWSMerchantFulfillmentServiceMock 
    ...
    */
    ...
    public GetAdditionalSellerInputsResponse getAdditionalSellerInputs(GetAdditionalSellerInputsRequest request) 
            throws MWSMerchantFulfillmentServiceException {
        return newResponse(GetAdditionalSellerInputsResponse.class);
    }
    ...
    *           GetAdditionalSellerInputsRequest request.
    *
    * @return Future<GetAdditionalSellerInputsResponse> Future containing completed response
    *
    * @throws MWSMerchantFulfillmentServiceException
    */
    public Future<GetAdditionalSellerInputsResponse> getAdditionalSellerInputsAsync(GetAdditionalSellerInputsRequest request) {
        return newFuture(getAdditionalSellerInputs(request));
    }
